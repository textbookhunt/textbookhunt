...
import { Profiles, ProfilesSchema } from '../../api/profile/Profile';
...
class EditProfile extends React.Component {
  ...
  submit(data) {
    const { firstName, lastName, major, email, description, _id } = data;
    Profiles.update(_id, { $set: { firstName, lastName, major, email, description } }, (error) => (error ?
